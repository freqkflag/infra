#!/bin/bash
#
# Refactor Agent Helper Script
# Quick invocation for refactor agent
#
# Usage:
#   ./refactor.sh [output_file]
#
...
echo -e "${BLUE}Invoking refactor agent...${NC}"
echo -e "${YELLOW}Purpose: Refactoring target identifier and duplication detector${NC}"
echo ""
...
$(cat "$AGENTS_DIR/refactor-agent.md")
...
echo ""
echo -e "${BLUE}Agent file: $AGENTS_DIR/refactor-agent.md${NC}"
