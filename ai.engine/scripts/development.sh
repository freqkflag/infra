#!/bin/bash
#
# Development Agent Helper Script
# Quick invocation for development agent
#
# Usage:
#   ./development.sh [output_file]
#
...
echo -e "${BLUE}Invoking development agent...${NC}"
echo -e "${YELLOW}Purpose: Full technical sweep and development analysis${NC}"
echo ""
...
$(cat "$AGENTS_DIR/development-agent.md")
...
echo ""
echo -e "${BLUE}Agent file: $AGENTS_DIR/development-agent.md${NC}"
