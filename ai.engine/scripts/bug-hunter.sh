#!/bin/bash
#
# Bug Hunter Agent Helper Script
# Quick invocation for bug_hunter
#
# Usage:
...
echo -e "${BLUE}Invoking bug_hunter...${NC}"
echo -e "${YELLOW}Purpose: Aggressive bug scanner for errors, code smells, and instability${NC}"
echo ""
...
$(cat "$AGENTS_DIR/bug-hunter-agent.md")
...
echo ""
echo -e "${BLUE}Agent file: $AGENTS_DIR/bug-hunter-agent.md${NC}"
