 ...
 * This can be used as a custom static homepage
 *
		...
		<div class="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
			...
			<div class="lg:col-span-7 flex flex-col gap-6">
				...
				<div class="flex flex-wrap gap-4 mt-4">
					<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal' ) ); ?>" class="font-heading font-semibold text-lg px-8 py-3.5 bg-primary text-background rounded-full hover:bg-primarySoft hover:shadow-neon-primary transition-all duration-200 ease-out active:scale-95">
						Enter the Archive
					</a>
		...
		<section class="py-20 bg-background border-t border-border">
			<div class="container mx-auto px-6">
				<div class="flex justify-between items-end mb-12">
					...
					<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal' ) ); ?>" class="hidden md:block text-accent hover:text-white transition-colors font-heading">View All →</a>
				</div>
				...
				<div class="mt-8 md:hidden text-center">
					<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal' ) ); ?>" class="text-accent font-heading">View All Signals →</a>
				</div>
			</div>
		</section>
		<?php wp_reset_postdata(); ?>
