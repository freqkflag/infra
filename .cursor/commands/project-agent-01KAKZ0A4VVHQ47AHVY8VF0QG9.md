---
runme:
  id: 01KAM0Y7368D225FHP74SQ38MT
  version: v3
  document:
    relativePath: project-agent.md
  session:
    id: 01KAKZ0A4VVHQ47AHVY8VF0QG9
    updated: 2025-11-21 20:16:52Z
---
...
BEGIN ANALYSIS NOW AND RETURN THE JSON REPORT.rite your command content here.

This command will be available in chat with /project-agent
