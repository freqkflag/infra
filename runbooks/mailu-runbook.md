...
**Domain(s):** mail.freqkflag.co  
**URL(s):** https://mail.freqkflag.co
...
```bash
docker exec mailu [health-check-command]
```
...
- Location: `/root/infra/mailu/.env`
- Key variables:
  - `[VAR1]` - [description]
  - `[VAR2]` - [description]

### Docker Compose
- Location: `/root/infra/mailu/docker-compose.yml`
...
tar -xzf mailu-backup-YYYYMMDD.tar.gz -C /
...
- Application logs: `/root/infra/mailu/data/logs/`
...
### Performance Issues
1. Check resource usage: `docker stats mailu`
...
- [Service README](../mailu/README.md)
