...
**Domain(s):** nodered.freqkflag.co  
**URL(s):** https://nodered.freqkflag.co
...
```bash
docker exec nodered [health-check-command]
```
...
- Location: `/root/infra/nodered/.env`
- Key variables:
  - `[VAR1]` - [description]
  - `[VAR2]` - [description]

### Docker Compose
- Location: `/root/infra/nodered/docker-compose.yml`
...
tar -xzf nodered-backup-YYYYMMDD.tar.gz -C /
...
- Application logs: `/root/infra/nodered/data/logs/`
...
### Performance Issues
1. Check resource usage: `docker stats nodered`
...
- [Service README](../nodered/README.md)
